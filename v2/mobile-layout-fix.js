...
.header{overflow:hidden}.header>*{min-width:0}.brand{min-width:0;overflow:hidden}.frame-wrap{overflow:hidden}
iframe{display:block;max-width:100%;min-width:0}.nav{overflow:hidden}.nav button{min-width:0;max-width:100%;overflow:hidden}.nav button span{max-width:100%;overflow:hidden;text-overflow:ellipsis}
@media(max-width:540px){
  .header{gap:5px;padding-left:max(9px,env(safe-area-inset-left));padding-right:max(9px,env(safe-area-inset-right))}
  .brand small{font-size:8px;letter-spacing:.055em}.brand b{font-size:16px}
  .pr-status-btn{font-size:0!important;width:36px!important;min-width:36px!important;padding:0!important;flex:0 0 36px!important}.pr-status-btn:before{content:'✓';font-size:15px}
  .jc-toolbar{gap:4px!important;flex:0 0 auto}.jc-tool{width:36px!important;min-width:36px!important;padding:0!important;display:grid!important;place-items:center!important}.jc-tool span{display:none!important}
  .lang-toggle{width:40px!important;min-width:40px!important;padding:0!important;flex:0 0 40px!important}.lang-toggle span{display:none!important}
  ...
  .nav button i{font-size:19px!important}.nav button span{font-size:10px!important}
}
@media(max-width:390px){
  .brand small{font-size:7.5px}.brand b{font-size:15px}
...
.actions,.filter-row{max-width:100%!important}.btn,.filter{min-width:0!important;max-width:100%!important;overflow-wrap:anywhere!important}
@media(max-width:540px){
  ...
  .day-glance{padding:12px!important}.day-glance-row{padding-left:8px!important;padding-right:8px!important;gap:8px!important}
  .day-glance-row b{font-size:13px!important}.day-glance-row small{font-size:12px!important}
  .event-head{gap:6px!important}.event-head h3{font-size:17px!important}
