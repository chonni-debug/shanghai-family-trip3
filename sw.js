const CACHE='shanghai-family-trip-v2.18';
...
const ESSENTIAL=[
  ...
  './v2/contextual-suggestions.css',
  './v2/itinerary-v3.css',
  './v2/mobile-detail-hotfix.css',
  './v2/day-route-map.css',
  './v2/photo-integrity.css',
  './v2/usability.css',
  './v2/production-readiness.css',
  './v2/trip-readiness-ui.css',
  './v2/app-core.js',
  ...
  './v2/revised-place-overrides.js',
  './v2/hangzhou-sep16-override.js',
  './v2/sep15-user-details.js',
  './v2/day2-user-details.js',
  './v2/contextual-suggestions.js',
  './v2/itinerary-v3.js',
  './v2/bund-photo-walk.js',
  './v2/day-route-map.js',
  './v2/mobile-detail-hotfix.js',
  './v2/verified-photo-library.js',
  './v2/photo-integrity.js',
  './v2/usability.js',
  './v2/production-readiness.js',
  './v2/trip-readiness-ui.js',
  ...
  './data/reference-itinerary-ideas.json',
  './data/revised-plan-content.json',
  './data/revised-place-overrides.json',
  './data/plan-2026-09-v2.json',
  './data/trip-readiness.json',
  './data/day-route-maps.json',
  './data/hangzhou-sep16-plan.json',
  './data/sep15-user-details.json',
  './data/day2-user-details.json',
  './data/day1-citywalk.json',
  './data/day1-bund-photo-walk.json',
